              ...
              <div className='abgridboarddiv'>
                ...
                <div className='abboarddiv'>
                  <div className='abboardindiv'>
                    <div><div className='abimgdiv'><img className='abimgtag' src={require("../assets/ss.jpeg")} alt="JAN"></img></div></div>
                    <div><h3>SUDERSUN S</h3></div>
                  </div>
                  <div className='abboardindiv'>
                    <div><div className='abimgdiv'><img className='abimgtag' src={require("../assets/vis.jpeg")} alt="JAN"></img></div></div>
